...
public class MediatorLesson {
    public static void main(String[] args) {
        ...
        mediator.add(new ConcreteColleague(mediator, "1"));
        mediator.add(new ConcreteColleague(mediator, "2"));
        ConcreteColleague concreteColleague = new ConcreteColleague(mediator, "3");
